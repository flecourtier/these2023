...
\begin{document}
	...
	\chapter{Levelset}
	\newpage
	\graphicspath{{levelset/images/1_introduction}}
	\input{levelset/sections/1_introduction}
	\newpage
	\graphicspath{{levelset/images/2_maths_theory}}
	\input{levelset/sections/2_maths_theory}
	\newpage
	\graphicspath{{levelset/images/3_learning}}
	\input{levelset/sections/3_learning}

	\chapter{Introduction}
	\newpage
	\graphicspath{{introduction/images/1_application}}
	\input{introduction/sections/1_application}
	\newpage
	\graphicspath{{introduction/images/2_contrib}}
	\input{introduction/sections/2_contrib}
\end{document}