...
\begin{itemize}[label=$\square$] 
	...
	\begin{itemize}[label=\LARGE $\circ$]
		...
		\item Configurer VsCode : Copylot + Github + Extensions ?
		\item Installation de LaTex (+ texstudio) $\rightarrow$ check si présentation compile
		\item Installation de ce qu'il faut pour ToDoApp
