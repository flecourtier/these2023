...
\begin{frame}[noframenumbering]{Physics-Informed Neural Networks}
	...
	\begin{minipage}{0.23\linewidth}
		\vspace{-15pt}
		\hspace{-23pt}\includegraphics[width=1.3\linewidth]{images/classical_approaches/levelset.png}
	\end{minipage}
...
\begin{frame}{Finite Element Method\footcite{Ern2004TheoryAP}}	
	...
	\end{minipage} \qquad \begin{minipage}[t][][b]{0.2\linewidth}
		% \vspace{-5pt}
		\centering
		\pgfimage[width=0.9\linewidth]{images/classical_approaches/FEM_triangle_mesh.png}
	...
	\vspace{-5pt}
	Find $U\in\mathbb{R}^{N_\text{dofs}}$ such that \hspace{40pt} $AU=b$

	with 
	\begin{equation*}
		A=\big(a(\phi_i,\phi_j)\big)_{1\le i,j\le N_\text{dofs}} \quad \text{and} \quad b=\big(l(\phi_j)\big)_{1\le j\le N_\text{dofs}}.
	\end{equation*}
	\vspace{-3pt}
\end{frame}