...
\begin{frame}{Online phase - 1 set of parameters I}
	\vspace{-12pt}
...
\begin{frame}{Online phase - 1 set of parameters II}
	\vspace{-12pt}
	$$\bm{\mu}^{(1)}=(0.05, 0.22, 0.1) $$
...
\begin{frame}{Parametric framework}
	\textbf{How many parameters $n_p$ are needed to balance training?}
