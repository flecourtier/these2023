...
\begin{document}
	...
	\section{Extension to non-linear problems}

	\input{sections/navier_stokes}
	...
	\begin{frame}{Conclusion}
		\begin{itemize}
			...
			\item \textbf{Extension to non-linear problems} : \\
			First promising results for the incompressible Navier-Stokes equations.
		\end{itemize}

		\begin{minipage}{0.6\linewidth}
			\textbf{Perspectives:}
			\begin{itemize}
				\item Improve Navier-Stokes results:
				\begin{itemize}
					\item Improved parametric PINN training.
					\item Different meshes by unknowns (+ parameter dependency).
				\end{itemize}
				\item Extend the approach to more complex geometries.
			\end{itemize}
		\end{minipage}\hfill
