...
\newcommand*{\footcite}[1]{\footnote[frame,1]{\cite{#1}}}
...
\begin{document}
	...
	\input{sections/numerical_results_poisson}

	\section{Numerical results - 2D anysotropic Elliptic problem}
	\input{sections/numerical_results_ell}
