...
\newcommand{\cvgunifadapt}[4]{
    ...
    \begin{cvgh}{4}
        ...
        \expandafter\printslopeinv\expandafter{3}{\second}{1e-4}{\diff}
        ...
        \expandafter\printslopeinv\expandafter{3}{\second}{5e-5}{\diff}
    \end{cvgh}
}

\begin{document}
    \cvgunifadapt{param3/FEM_case4_v2_param9_degree1.csv}{param3/FEMPrev_case4_v2_param9_degree1.csv}{param3/FEMNet_case4_v2_param9_degree1.csv}{param3/ADD_case4_v2_param9_degree1.csv}
\end{document}