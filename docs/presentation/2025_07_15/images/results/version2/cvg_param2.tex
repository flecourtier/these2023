...
\newcommand{\cvgunifadapt}[4]{
    ...
    \begin{cvgh}{4}
        ...
        \addplot [style={solid}, mark=square, mark size=4.5, color=lime!80!black, line width=0.8pt, mark options={fill=lime!80!black, draw=lime!80!black, line width=1pt} ]
        table [x=h, y=err_U_1, col sep=comma]
        {\femUn}; \addlegendentry{\,Standard\;}
        
        \addplot [style={dashdotted}, mark=square, mark size=2.5, color=cyan!60!black, line width=0.8pt, mark options={fill=cyan!60!black, draw=cyan!60!black, line width=1pt, style={solid}} ]
        table [x=h, y=err_U_1, col sep=comma]
        {\femprevUn}; \addlegendentry{\,Incremental\;}

        \addplot [style={dashed}, mark=square*, mark size=1, color=black, line width=0.8pt, mark options={fill=black, draw=black, line width=0pt} ]
        table [x=h, y=err_U_1, col sep=comma]
...
\begin{document}
    \cvgunifadapt{param2/FEM_case4_v2_param4_degree1.csv}{param2/FEMPrev_case4_v2_param4_degree1.csv}{param2/FEMNet_case4_v2_param4_degree1.csv}{param2/ADD_case4_v2_param4_degree1.csv}
\end{document}