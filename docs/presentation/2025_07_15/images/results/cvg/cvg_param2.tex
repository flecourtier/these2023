...
\newcommand{\cvgunifadapt}[4]{
    ...
    \begin{cvgh}{4}
        ...
        {\femUn}; \addlegendentry{\,Standard \textbf{\textcolor{red}{(10/X)}}\;}
        ...
        table [x=h, y=err_U_1, col sep=comma]
        {\femprevUn}; \addlegendentry{\,Incremental \textbf{\textcolor{red}{(4)}}\;}
        ...
        table [x=h, y=err_U_1, col sep=comma]
        {\feminitUn}; \addlegendentry{\,DeepPhysics \textbf{\textcolor{red}{(3)}}\;}
        ...
        table [x=h, y=err_U_1, col sep=comma]
        {\addUn}; \addlegendentry{\,\textbf{Additive} \textbf{\textcolor{red}{(3)}}\;}
