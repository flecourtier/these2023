...
\newcommand{\cvgunifadapt}[4]{
    ...
    \begin{cvgh}{4}
        ...
        {\femUn}; \addlegendentry{\,Std - Natural init \textbf{\textcolor{darkred}{(10/X)}}\;}
        ...
        table [x=h, y=err_U_1, col sep=comma]
        {\femprevUn}; \addlegendentry{\,Std - Continuation \textbf{\textcolor{darkred}{(4)}}\;}
        ...
        table [x=h, y=err_U_1, col sep=comma]
        {\feminitUn}; \addlegendentry{\,Std - PINN init \textbf{\textcolor{darkred}{(3)}}\;}
        ...
        table [x=h, y=err_U_1, col sep=comma]
        {\addUn}; \addlegendentry{\,\textbf{Additive} \textbf{\textcolor{darkred}{(3)}}\;}

        \expandafter\printslopeinv\expandafter{3}{\second}{1e-7}{\diff}
...
\begin{document}
    \cvgunifadapt{../data/param2/FEM_case4_v2_param4_degree1.csv}{../data/param2/FEMPrev_case4_v2_param4_degree1.csv}{../data/param2/FEMNet_case4_v2_param4_degree1.csv}{../data/param2/ADD_case4_v2_param4_degree1.csv}
\end{document}