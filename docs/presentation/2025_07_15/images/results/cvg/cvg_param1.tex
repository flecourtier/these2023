...
\newcommand{\cvgunifadapt}[3]{
    ...
    \begin{cvgh}{3}
        ...
        {\femUn}; \addlegendentry{\,Std - Natural init \textbf{\textcolor{darkred}{(6 iterations)}} \;}
...
\begin{document}
    \cvgunifadapt{../data/param1/FEM_case4_v2_param1_degree1.csv}{../data/param1/FEMNet_case4_v2_param1_degree1.csv}{../data/param1/ADD_case4_v2_param1_degree1.csv}
\end{document}