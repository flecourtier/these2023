...
\newcommand{\cvgunifadapt}[4]{
    ...
    \begin{cvgh}{4}
        ...
        \addlegendimage{style={solid}, mark=square, mark size=4.5, color=\femcolor, line width=0.8pt, mark options={fill=\femcolor, draw=\femcolor, line width=1pt} }\addlegendentry{\,Standard \textbf{\textcolor{red}{(X)}}\;}

        \addplot [style={dashdotted}, mark=square, mark size=2.5, color=\feminitcolor, line width=0.8pt, mark options={fill=\feminitcolor, draw=\feminitcolor, line width=1pt, style={solid}} ]
        table [x=h, y=err_U_2, col sep=comma]
        {\femprevUn};\addlegendentry{\,Incremental \textbf{\textcolor{red}{(5)}}\;}

        \addplot [style={dashed}, mark=square*, mark size=1, color=\femnetcolor, line width=0.8pt, mark options={fill=\femnetcolor, draw=\femnetcolor, line width=0pt} ]
        table [x=h, y=err_U_2, col sep=comma]
        {\feminitUn};\addlegendentry{\,DeepPhysics \textbf{\textcolor{red}{(5)}}\;}
        
        \addplot [style={dashed}, mark=square*, mark size=4, color=\addcolor, line width=0.8pt, mark options={fill=\addcolor, draw=\addcolor, line width=0pt} ]
        table [x=h, y=err_U_2, col sep=comma]
        {\addUn};\addlegendentry{\,\textbf{Additive} \textbf{\textcolor{red}{(5)}}\;}
...
\begin{document}
    \cvgunifadapt{../data/param3/version2/FEM_case4_v2_param9_degree1.csv}{../data/param3/version2/FEMPrev_case4_v2_param9_degree1.csv}{../data/param3/version2/FEMNet_case4_v2_param9_degree1.csv}{../data/param3/version2/ADD_case4_v2_param9_degree1.csv}
\end{document}