...
\newcommand{\coststable}[1]{
    \pgfplotstabletypeset[
        ...
        columns/DoFsFEMPrev/.style={column name=\textbf{Inc/DPhy},fixed},
        ...
        columns={e,DoFsFEM,DoFsFEMPrev,DoFsADD,TimesFEM,TimesFEMPrev,TimesFEMNet,TimesADD},
        precision=2
    ]{#1}
}
...
\begin{document}
    \centering
    \coststable{../data/param3/version2/TabTimes_case4_v2_param9_degree1.csv}
\end{document}