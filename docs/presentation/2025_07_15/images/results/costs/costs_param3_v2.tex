...
\newcommand{\coststable}[1]{
    \pgfplotstabletypeset[
		...
		% columns/DoFsFEM/.style={column name=\textbf{(nat)},fixed, string type, postproc cell content/.code={\pgfkeysalso{@cell content=X}}},
        columns/DoFsFEMPrev/.style={column name=\textbf{Std},fixed},
        ...
        columns/TimesFEM/.style={column name=\textbf{(nat)},fixed, string type, postproc cell content/.code={\pgfkeysalso{@cell content=X}}},
        ...
        columns={e,DoFsFEMPrev,DoFsADD,TimesFEM,TimesFEMPrev,TimesFEMNet,TimesADD},
        precision=2
    ]{#1}
}
