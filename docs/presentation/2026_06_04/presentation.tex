	...
	\begin{frame}{Conclusion}
		\begin{itemize}
			...
			\begin{itemize}
				...
				Quick and accurate resolution of the FEM correction problem using the PINN prior.
			\end{itemize}
			\item \textbf{Numerical results:} Several parametrics PDEs. 
		\end{itemize}

		\begin{minipage}{0.71\linewidth}
			\textbf{Some extensions:}
			\begin{itemize}
