...
\begin{document}
    \begin{tcolorbox}[
        ...
        width=18cm,
        height=4.3cm,
        title=\LARGE \textbf{ONLINE (fixed $\bm{\mu}$) :} PINN evaluation + Enriched FEM resolution,
        halign title=center
        ]
        ...
        \begin{tikzpicture}
            ...
            \node at (10.5,1.1) {\LARGE$\textcolor{red}{u_\theta}$\large$(\cdot,\bm{\mu})$ : prediction for};
            \node at (10.5,0.5) {\large the given parameter $\mu$};

            \draw[->, black, line width=2pt] (13.25,1.25) -- (14.25,1.25);
            \node at (15.40,0.25) {\large \textbf{\textcolor{orange}{FEM} solver}};
