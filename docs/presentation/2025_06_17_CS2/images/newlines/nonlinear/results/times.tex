...
\begin{document}
    \cvgerrortimeUn{data/data_FEM_P1.csv}{data/data_FEMinit_P1.csv}{data/data_ADD_P1.csv}{
        0.0001
    }
    \hspace{-40pt}
    \cvgerrortimeD{data/data_FEM_P2.csv}{data/data_FEMinit_P2.csv}{data/data_ADD_P2.csv}{
        0.0001
    }
    \hspace{-40pt}
    \cvgerrortimeT{data/data_FEM_P3.csv}{data/data_FEMinit_P3.csv}{data/data_ADD_P3.csv}{
        0.0001
    }
