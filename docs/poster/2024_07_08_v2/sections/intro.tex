\block{Scientific context \\ \large Create real-time digital twins of an organ (e.g. liver)}{
				...
				\begin{tcolorbox}[
					...
					\begin{center}
						\begin{tikzpicture}
							...
							%		
							\node[align=center] at (28,4.3) {Train a PINNs \\ \cite{raissi_physics-informed_2019}};
		...
		\textbf{Problem considered :} Poisson problem with Dirichlet boundary conditions (BC).
}
		
	\node[rotate=-30,below left=1cm and -1cm] at (topright) {\includegraphics[width=10cm]{images/intro/foie.png}};
