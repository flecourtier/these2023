...
\newenvironment{cvgh}[4]{
    \begin{tikzpicture}
        ...
        \pgfplotstablegetelem{\secondrow}{Ndofs}\of\datatable
        ...
        \pgfplotstablegetelem{\firstrow}{Ndofs}\of\datatable
        ...
        \begin{loglogaxis}[
            ...
            % ticks and labels
            xtick=data,
            xticklabels from table={\datatable}{Ndofs},
            extra x ticks={598},
            extra x tick labels={\textcolor{blue}{$598\;\;$}},
        ...
        % \expandafter\printslope\expandafter{\slopes}{\second}{\ypos}{\diff}
    }
    {
        \end{loglogaxis}
...
\newcommand{\cvgFEMCorrOnePlus}[4]{
    \edef\fem{#1}
    \edef\add{#2}
    \edef\addnet{#3}

    \begin{cvgh}{\fem}{1}{2}{#4}
        % Complete the legend
        % \addlegendentry{\,FEM $\mathbb{P}_1$\;}
        % \addlegendentry{\,FEM $\mathbb{P}_2$\;}
        % \addlegendentry{\,FEM $\mathbb{P}_3$\;}
        \addlegendentry{\,Add $\mathbb{P}_1$ (cartesian mesh)\;}
        \addlegendentry{\,Add $\mathbb{P}_1$ (adapted mesh)\;}
        ...
        % table [x=Ndofs, y=P1, col sep=comma]
        %     {\fem};
        ...
        table [x=Ndofs, y=P1, col sep=comma]
            {\add};
        \addplot [style={dashed}, mark=square*, mark size=2, color=blue, line width=0.8pt ]
        table [x=Ndofs, y=P1, col sep=comma]
            {\addnet};
...
\begin{document}
    \cvgFEMCorrOnePlus{FEM_case1_v1_param1.csv}{Corr_case1_v1_param1.csv}{Corr_case1_v1_param1_meshfromnet.csv}{1e-5}
\end{document}