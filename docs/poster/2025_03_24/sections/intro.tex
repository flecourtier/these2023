\block{Motivations}{
		...
		\textbf{Long term objective :} Create real-time digital twins of an organ (e.g. liver).
		\vspace{-20pt}
}
		
\node[rotate=-30,below left=0.5cm and -0.5cm] at (topright) {\includegraphics[width=9cm]{images/intro/foie.png}};