...
\begin{columns}
    ...
    %     \begin{center}
    %         \vspace{-20pt}
    %         \hspace{200pt}\includegraphics[width=0.58\linewidth]{images/persp/cat.png}
            
    %         \vspace{-100pt}
    %         \hspace{-220pt}\includegraphics[width=0.6\linewidth]{images/persp/liver.png}
    %     \end{center}
    %     \vspace{-30pt}
    % }

    \block{More complex geometries}{
        % \vspace{-20pt}
        \begin{center}
            \vspace{-20pt}
            \flushright\includegraphics[width=0.68\linewidth]{images/persp/cat.png}
            
            \vspace{-80pt}
            \flushleft\includegraphics[width=0.7\linewidth]{images/persp/liver.png}
        \end{center}
        \vspace{-30pt}
    }
