...
\institute{\parbox{\linewidth}{\small $^1$ Mimesis team, INRIA Nancy grand Est, Icube $\quad$ $^2$ Makutu team, INRIA Bordeaux, TotalEnergies $\quad$ $^3$ Macaron team, INRIA Nancy grand Est, IRMA $\quad$ $^4$ Montpellier University}}
...
\begin{document}
	\maketitle[titletoblockverticalspace=20pt,titlegraphictotitledistance=1pt]
