...
from scar.equations.run_ShapePoisson2D import *
...
def get_args():
    ...
    parser.add_argument("--w_res", help="Weight in the Eikonal loss.", type=float, default=100.0)
...
dir_name = "../networks/ShapePoisson2D/"+geom_class_name+"/"
...
run_ShapePoisson2D(form,config,dict_config,new_training = False,createxyzfile=True)